        ...
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <div className="max-w-4xl">
            ...
            <p className="font-paragraph text-lg md:text-xl text-foreground/70 mb-8 max-w-3xl">
              Careless driving is a serious charge under the Highway Traffic Act with severe penalties including licence suspension, heavy fines, and possible jail time. You need professional representation.
            </p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          ...
          <p className="font-paragraph text-lg text-foreground/70 text-center mb-12 max-w-3xl mx-auto">
            Careless driving under Section 130 of the Highway Traffic Act carries significant consequences.
          </p>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-pastelbeige/20 to-transparent">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="font-paragraph text-lg text-foreground/70 mb-8 text-center">
              Under Section 130 of the Highway Traffic Act, careless driving means operating a vehicle "without due care and attention or without reasonable consideration for other persons."
            </p>
              ...
              <div className="bg-white rounded-lg p-6 border border-pastelbeige">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="font-paragraph text-foreground/70">Rear-end collisions</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <XCircle className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-foreground/70">Failing to yield right of way</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <XCircle className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-foreground/70">Unsafe lane changes</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <XCircle className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-foreground/70">Running red lights or stop signs</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <XCircle className="w-5 h-5 text-red-500 flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-foreground/70">Distracted driving incidents</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 border border-pastelbeige">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="font-paragraph text-foreground/70">Momentary lapse vs. pattern of driving</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-foreground/70">Weather or road conditions</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-foreground/70">Mechanical failure</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-foreground/70">Actions of other drivers</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                    <span className="font-paragraph text-foreground/70">Medical emergency</span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <section className="py-16 md:py-24 bg-secondary text-secondary-foreground">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8 text-center">
          ...
          <p className="font-paragraph text-lg text-secondary-foreground/80 mb-8 max-w-2xl mx-auto">
            This is a serious charge that requires experienced representation. Contact us immediately for a free case review.
          </p>
