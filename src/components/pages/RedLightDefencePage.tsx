...
export default function RedLightDefencePage() {
  ...
  const honestFAQs = [
    ...
    { question: "What defences work for red light tickets?", answer: "For officer-issued tickets, common defence angles include: challenging the officer's vantage point and ability to observe the light at the intersection, amber-light timing arguments, emergency circumstances (necessity), and improper intersection design or signal timing issues. Realistic outcomes range from withdrawal (where the officer's vantage was obstructed or the disclosure is weak), reduction to a zero-point offence, acquittal at trial, or conviction-as-charged. Outcome depends on the disclosure, your record, and the assigned Crown." },
