...
export default function BlogListPage() {
  ...
  const blogListSchema = {
    ...
    '@type': 'CollectionPage',
    name: 'Legal Assist Blog — Ontario Legal Resources',
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Legal Blog — Ontario Paralegal Resources | Legal Assist</title>
        ...
        <meta property="og:title" content="Legal Blog — Ontario Paralegal Resources | Legal Assist" />
        ...
        <meta name="twitter:title" content="Legal Blog — Ontario Paralegal Resources | Legal Assist" />
