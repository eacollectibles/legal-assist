...
export default function TemiskamingShorersParalegalPage() {
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <div className="max-w-4xl">
            <div className="flex items-center gap-2 text-primary mb-4">
              ...
              <span className="font-paragraph text-sm font-medium">Serving Temiskaming Shores & Northeastern Ontario</span>
            </div>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-12 text-center">Our Services in Temiskaming Shores</h2>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-xl shadow-sm p-8">
              <p className="font-paragraph text-foreground/80 mb-6">
                We regularly appear at courts serving Temiskaming Shores and Temiskaming District:
              </p>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="space-y-2">
                    {[
                      'Ontario Court of Justice - Temiskaming Shores (325 Farr Drive)',
                      'Temiskaming Shores Small Claims Court',
                      'Provincial Offences Court - Temiskaming Shores',
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-8 text-center">Why Temiskaming Shores Residents Choose Us</h2>
          <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-6">
            {[
              { title: 'Affordable Rates', desc: 'Paralegal services cost significantly less than lawyers while providing experienced representation in Temiskaming Shores.' },
              { title: 'Flexible Scheduling', desc: 'Evening and weekend consultations available. We accommodate the schedules of Temiskaming District working families.' },
              { title: 'Virtual Options', desc: 'Many matters can be handled remotely—phone and video consultations available for Temiskaming Shores clients.' },
            ].map((item, index) => (
      ...
      <section className="py-16 md:py-20 bg-primary text-primary-foreground">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8 text-center">
          ...
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-6">Need Legal Help in Temiskaming Shores?</h2>
          <p className="font-paragraph text-lg mb-8 opacity-90 max-w-2xl mx-auto">
            Free consultation to discuss your case. Serving all of Temiskaming District and Northeastern Ontario.
          </p>
