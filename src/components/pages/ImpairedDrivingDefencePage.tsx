...
export default function ImpairedDrivingDefencePage() {
  ...
  const honestFAQs = [
    { question: "Can a paralegal defend impaired driving charges?", answer: "No - impaired driving under the Criminal Code (s.320.14, post-Bill C-46) requires a criminal defence lawyer. However, I can help with: administrative driver's licence suspensions (ADLS) issued under HTA s.48.0.1, the related provincial regulatory matters that often accompany an impaired charge (e.g. fail-to-surrender insurance, fail-to-remain), and navigating the overall process while you find criminal counsel." },
    { question: "What's the difference between criminal impaired and 'warn range'?", answer: "Criminal impaired (Criminal Code s.320.14(1)(b) - BAC at or over 80mg/100mL) is a hybrid offence carrying potential jail, criminal record, mandatory licence prohibition (1 year minimum first offence), and an Interlock Ignition program. 'Warn range' (0.05-0.079 BAC) is a provincial Administrative Driver's Licence Suspension under HTA s.48.0.1 - 3 days first, 7 days second, 30 days third (lifetime escalation possible). Warn-range matters and the related licensing reinstatement issues I can help with." },
