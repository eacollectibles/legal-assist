...
export default function WellandParalegalPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <div className="max-w-4xl">
            <div className="flex items-center gap-2 text-primary mb-4">
              ...
              <span className="font-paragraph text-sm font-medium">Serving Welland &amp; South Niagara</span>
            </div>
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">Welland Paralegal Services</h1>
            <p className="font-paragraph text-lg md:text-xl text-foreground/70 mb-8 max-w-3xl">Affordable paralegal representation for Welland and south Niagara Region. Traffic tickets, Small Claims Court, LTB hearings, and provincial offences.</p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-12 text-center">Legal Services for Welland Residents</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: Car, title: 'Traffic Ticket Defence', desc: 'Highway 140, Highway 58, King Street, Welland area streets. Speeding, careless driving.', link: '/services/traffic-tickets' },
              { icon: Scale, title: 'Small Claims Court', desc: 'Up to $50,000 at Welland/St. Catharines courthouse. Debt collection, contract disputes.', link: '/services/small-claims' },
              { icon: Home, title: 'Landlord & Tenant Board', desc: 'South Niagara eviction defence, rent disputes, maintenance.', link: '/services/landlord-tenant' },
              { icon: Gavel, title: 'Provincial Offences', desc: 'By-law violations, trespass charges at Welland POA court.', link: '/services/provincial-offences' },
            ].map((service, index) => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-2">
                  {['Ontario Court of Justice - Welland', 'Small Claims Court - Welland', 'Provincial Offences Court - Welland', 'Landlord and Tenant Board (virtual)'].map((court) => (
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {['Welland', 'Pelham', 'Fonthill', 'Port Colborne', 'Wainfleet', 'Dunnville'].map((area) => (
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-pastelbeige/20 to-transparent">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-12 text-center">Why Choose Legal Assist for Welland</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Shield, title: 'LSO Licensed', desc: 'Fully regulated by the Law Society of Ontario for your protection.' },
              { icon: MapPin, title: 'Local Experience', desc: 'Deep knowledge of Welland courthouse and south Niagara procedures.' },
      ...
      <section className="py-16 md:py-24 bg-primary text-primary-foreground">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8 text-center">
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4">Need Legal Help in Welland?</h2>
          <p className="font-paragraph text-lg text-primary-foreground/80 mb-8 max-w-2xl mx-auto">Serving Welland and all of south Niagara.</p>
      ...
      <section className="py-8 md:py-12 bg-white">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8 text-center">
          <p className="font-paragraph text-sm text-foreground/70">Licensed by the Law Society of Ontario | Serving Welland &amp; South Niagara</p>
        </div>
      </section>
