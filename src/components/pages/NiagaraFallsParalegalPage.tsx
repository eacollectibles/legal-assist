...
export default function NiagaraFallsParalegalPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <div className="max-w-4xl">
            <div className="flex items-center gap-2 text-primary mb-4">
              ...
              <span className="font-paragraph text-sm font-medium">Serving Niagara Falls &amp; Niagara Region</span>
            </div>
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">Niagara Falls Paralegal Services</h1>
            <p className="font-paragraph text-lg md:text-xl text-foreground/70 mb-8 max-w-3xl">Affordable paralegal services for Niagara Falls and Niagara Region. Traffic tickets on QEW/Highway 420, Small Claims Court, LTB hearings, provincial offences.</p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-12 text-center">Legal Services for Niagara Falls Residents</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-2">
                  {['Ontario Court of Justice - St. Catharines', 'Small Claims Court - St. Catharines', 'Provincial Offences Court - Niagara Falls', 'Landlord and Tenant Board (virtual)'].map((court) => (
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {['Niagara Falls', 'Niagara-on-the-Lake', 'Fort Erie', 'Thorold', 'Chippawa', 'Welland'].map((area) => (
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-pastelbeige/20 to-transparent">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-12 text-center">Why Choose Legal Assist for Niagara Falls</h2>
      ...
      <section className="py-16 md:py-24 bg-primary text-primary-foreground">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8 text-center">
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4">Need Legal Help in Niagara Falls?</h2>
          <p className="font-paragraph text-lg text-primary-foreground/80 mb-8 max-w-2xl mx-auto">Serving all of Niagara Region.</p>
      ...
      <section className="py-8 md:py-12 bg-white">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8 text-center">
          <p className="font-paragraph text-sm text-foreground/70">Licensed by the Law Society of Ontario | Serving Niagara Falls &amp; Niagara Region</p>
        </div>
      </section>
