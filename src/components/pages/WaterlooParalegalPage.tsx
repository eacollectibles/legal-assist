...
export default function WaterlooParalegalPage() {
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <div className="max-w-4xl">
            <div className="flex items-center gap-2 text-primary mb-4">
              ...
              <span className="font-paragraph text-sm font-medium">Serving Waterloo & Waterloo Region</span>
            </div>
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
              Waterloo Paralegal Services
            </h1>
            <p className="font-paragraph text-lg md:text-xl text-foreground/70 mb-8 max-w-3xl">
              Professional paralegal services for Waterloo, Uptown, and the broader Waterloo Region. Traffic tickets, Small Claims Court, landlord-tenant disputes, and provincial offences.
            </p>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-12 text-center">Our Services in Waterloo</h2>
      ...
      <section className="py-16 md:py-20 bg-primary text-primary-foreground">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8 text-center">
          ...
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-6">Waterloo Legal Help</h2>
          <p className="font-paragraph text-lg mb-8 opacity-90 max-w-2xl mx-auto">
            Free consultation for Waterloo and Waterloo Region residents.
          </p>
      ...
      <section className="py-8 bg-gray-50">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8 text-center">
          <p className="font-paragraph text-sm text-foreground/60">
            ...
            Licensed by the Law Society of Ontario | Serving Waterloo & Waterloo Region
          </p>
        </div>
      </section>
