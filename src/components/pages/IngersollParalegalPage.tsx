...
export default function IngersollParalegalPage() {
  useEffect(() => {
    document.title = 'Paralegal Services in Ingersoll Ontario | LegalAssist';
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) {
      metaDesc.setAttribute('content', 'Licensed paralegal services in Ingersoll, Ontario. Affordable representation for Small Claims Court, Landlord Tenant Board, traffic tickets, and tribunals. Free consultation.');
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <div className="max-w-4xl">
            <div className="flex items-center gap-2 text-primary mb-4">
              ...
              <span className="font-paragraph text-sm font-medium">Serving Ingersoll &amp; Oxford County</span>
            </div>
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">Paralegal Services in Ingersoll, Ontario</h1>
            <p className="font-paragraph text-lg md:text-xl text-foreground/70 mb-8 max-w-3xl">Licensed paralegal representation for Small Claims Court, Landlord and Tenant Board, traffic tickets, and tribunal matters. Serving Ingersoll, Thamesford, Beachville, and all of Oxford County.</p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-12 text-center">Legal Services for Ingersoll Residents</h2>
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-pastelbeige/20 to-transparent">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-12 text-center">Why Ingersoll Clients Choose LegalAssist</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: Shield, title: 'LSO Licensed', desc: 'Fully regulated by the Law Society of Ontario for your protection.' },
              { icon: MapPin, title: 'Local Knowledge', desc: 'Familiar with Woodstock courthouse and Oxford County procedures.' },
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-8 text-center">Serving All of Oxford County</h2>
          <p className="font-paragraph text-lg text-foreground/70 text-center mb-12 max-w-2xl mx-auto">We provide paralegal services throughout Oxford County and surrounding areas.</p>
          
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 max-w-4xl mx-auto">
            {['Ingersoll', 'Woodstock', 'Thamesford', 'Beachville', 'Embro', 'Tavistock', 'Tillsonburg', 'Norwich', 'Drumbo', 'Plattsville', 'Bright', 'Innerkip'].map((city) => (
      ...
      <section className="py-16 md:py-24 bg-secondary text-secondary-foreground">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8 text-center">
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4">Need Legal Help in Ingersoll?</h2>
