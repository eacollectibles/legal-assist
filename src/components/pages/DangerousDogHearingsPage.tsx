...
export default function DangerousDogHearingsPage() {
  ...
  const honestFAQs = [
    ...
    { question: "What is the difference between dangerous dog and pit bull designation?", answer: "Ontario has province-wide breed-specific legislation (BSL) under the Dog Owners' Liability Act, 1990 (DOLA), as amended in 2005. Pit bulls are classified as a restricted breed - the original ban grandfathered existing pit bulls (registered, sterilized, leashed and muzzled in public); new pit bulls cannot be acquired in the province. The BSL remains in force as of 2026. Dangerous dog designation is separate and incident-based - applies to any breed that bites, attacks, or poses a serious threat. Breed designation under DOLA is automatic for pit bulls; dangerous-dog designation requires evidence of an incident. Some municipalities have additional dangerous-dog by-laws layered on top." },
