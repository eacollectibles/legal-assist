...
export default function ESAComplaintPage() {
  const authorityItems = [
    ...
    { title: 'No Statutory Cap', description: 'ESA Officers can order any amount of unpaid wages owed (the historical $10,000 cap was removed under Bill 18, 2015). MOL is free; the trade-off is speed (months) and limited remedies. Civil court remains an alternative.' }
  ];
  ...
  const honestFAQs = [
    ...
    { question: "My claim is over $15,000. What do I do?", answer: "There is no statutory cap on ESA Orders to Pay - Officers can order the full amount of unpaid wages owed. However, you generally cannot pursue both an ESA complaint AND a civil action for the same wages (s.97 election rule). Choose the forum that best fits your facts: ESA for clear-cut wage owings (free, slower), Small Claims for amounts up to $50,000 (filing fees, faster). Get advice on which forum is best for your facts." },
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                ...
                <ul className="text-red-900 text-sm space-y-1">
                  ...
                  <li>• Significant disputed amounts where you want courtroom-style cross-examination</li>
            ...
            <div className="overflow-x-auto mb-12">
              <table className="w-full border-collapse bg-white rounded-lg overflow-hidden shadow-sm">
                ...
                <tbody className="divide-y divide-border">
                  ...
                  <tr><td className="px-6 py-4 font-medium">Maximum recovery</td><td className="px-6 py-4">No statutory cap (ESA Officer determines)</td><td className="px-6 py-4 text-green-700 font-bold">$50,000 (Small Claims) / unlimited (Superior Court)</td></tr>
