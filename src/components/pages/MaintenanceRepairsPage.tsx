...
export default function MaintenanceRepairsPage() {
  ...
  const honestFAQs = [
    ...
    { question: "What about emergency repairs?", answer: "For emergencies (no heat in winter, major water leak, safety hazards), the landlord must respond immediately. If they don't, your options are: call municipal property standards / bylaw enforcement, contact your local public health unit for habitability issues, or file an urgent T6 application with the LTB. Note: Ontario's Residential Tenancies Act does NOT permit you to deduct repair costs from rent unilaterally — doing so puts you at risk of an L1 non-payment eviction. Get written agreement from the landlord before paying for repairs, or seek an order from the LTB." }
  ];
