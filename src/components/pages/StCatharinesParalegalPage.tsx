...
export default function StCatharinesParalegalPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <div className="max-w-4xl">
            <div className="flex items-center gap-2 text-primary mb-4">
              ...
              <span className="font-paragraph text-sm font-medium">Serving St. Catharines &amp; Niagara Region</span>
            </div>
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">St. Catharines Paralegal Services</h1>
            <p className="font-paragraph text-lg md:text-xl text-foreground/70 mb-8 max-w-3xl">Professional paralegal services for St. Catharines and the Niagara Peninsula. Traffic tickets on QEW/Highway 406, Small Claims, LTB, provincial offences.</p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-12 text-center">Legal Services for St. Catharines Residents</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: Car, title: 'Traffic Ticket Defence', desc: 'QEW, Highway 406, Ontario Street, Geneva Street. Speeding, careless driving.', link: '/services/traffic-tickets' },
              { icon: Scale, title: 'Small Claims Court', desc: 'Up to $50,000 at St. Catharines courthouse. Contract disputes, property damage.', link: '/services/small-claims' },
              { icon: Home, title: 'Landlord & Tenant Board', desc: 'Niagara Region eviction defence, rent disputes, maintenance issues.', link: '/services/landlord-tenant' },
              { icon: Gavel, title: 'Provincial Offences', desc: 'By-law violations, regulatory offences at St. Catharines POA court.', link: '/services/provincial-offences' },
            ].map((service, index) => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-2">
                  {['Ontario Court of Justice - St. Catharines', 'Superior Court of Justice - St. Catharines', 'Provincial Offences Court - St. Catharines', 'Landlord and Tenant Board (virtual)'].map((court) => (
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {['St. Catharines', 'Thorold', 'Merritton', 'Port Dalhousie', 'Jordan', 'Vineland'].map((area) => (
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-pastelbeige/20 to-transparent">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-12 text-center">Why Choose Legal Assist for St. Catharines</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Shield, title: 'LSO Licensed', desc: 'Fully regulated by the Law Society of Ontario for your protection.' },
              { icon: MapPin, title: 'Local Experience', desc: 'Deep knowledge of St. Catharines courthouse and Niagara Peninsula procedures.' },
      ...
      <section className="py-16 md:py-24 bg-primary text-primary-foreground">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8 text-center">
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-4">Need Legal Help in St. Catharines?</h2>
          <p className="font-paragraph text-lg text-primary-foreground/80 mb-8 max-w-2xl mx-auto">Serving St. Catharines and the Niagara Peninsula.</p>
      ...
      <section className="py-8 md:py-12 bg-white">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8 text-center">
          <p className="font-paragraph text-sm text-foreground/70">Licensed by the Law Society of Ontario | Serving St. Catharines &amp; Niagara Region</p>
        </div>
      </section>
