...
export default function UnpaidWagesPage() {
  ...
  const honestFAQs = [
    ...
    { question: "Ministry of Labour or court—which is better?", answer: "Ministry of Labour: free, simpler, but processing takes months. ESA Officers can order any amount of unpaid wages (the historical $10,000 cap was removed under Bill 18, 2015 - there is no statutory cap). Court: filing fees apply, more complex, but Small Claims handles up to $50,000 (raised from $35,000 effective Jan 1, 2025) and is often faster. Above $50K you need Superior Court / a lawyer. Depends on amount owed and strength of case." },
