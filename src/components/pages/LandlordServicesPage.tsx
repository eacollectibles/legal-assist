...
import { ArrowRight, Phone, Home, Shield, Clock, CheckCircle, FileText, Scale, Users, AlertTriangle } from 'lucide-react';
...
export default function LandlordServicesPage() {
  ...
  const services = [
    {
      title: 'Non-Payment of Rent (N4)',
      description: 'Eviction applications when tenants fail to pay rent. We handle the entire process from notice to enforcement.',
      link: '/services/eviction-non-payment',
    },
    {
      title: 'Property Damage &amp; Disturbance (N5)',
      description: 'Applications for substantial interference, damage to property, or safety concerns.',
      link: '/services/landlord-tenant',
    },
    {
      title: 'Illegal Activity (N6/N7)',
      description: 'Evictions for illegal acts, misrepresentation, or serious safety issues.',
      link: '/services/landlord-tenant',
    },
    {
      title: 'End of Tenancy (N12/N13)',
      description: 'Personal use, purchaser use, or renovation/demolition evictions.',
      link: '/services/landlord-tenant',
    },
    {
      title: 'Above Guideline Increases',
      description: 'Applications for rent increases above the annual guideline for capital expenditures.',
      link: '/services/landlord-tenant',
    },
    {
      title: 'LTB Hearing Representation',
      description: 'Full representation at Landlord and Tenant Board hearings in person or virtual.',
      link: '/services/landlord-tenant',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <div className="max-w-4xl">
            ...
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
              Ontario Landlord Legal Services
            </h1>
            <p className="font-paragraph text-lg md:text-xl text-foreground/70 mb-8 max-w-3xl">
              Professional paralegal representation for Ontario landlords. From eviction applications to LTB hearings, we protect your property rights and help you navigate the Residential Tenancies Act.
            </p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          ...
          <p className="font-paragraph text-lg text-foreground/70 text-center mb-12 max-w-3xl mx-auto">
            Comprehensive legal support for all landlord matters before the Landlord and Tenant Board.
          </p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-12 text-center">
            Why Landlords Choose LegalAssist
          </h2>
