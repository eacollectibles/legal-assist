  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-pastelbeige/20 to-transparent">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-12 text-center">Why Choose Legal Assist for Markham</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Shield, title: 'LSO Licensed', desc: 'Fully regulated by the Law Society of Ontario for your protection.' },
              { icon: MapPin, title: 'Local Experience', desc: 'Deep knowledge of Newmarket courthouse and York Region procedures.' },
