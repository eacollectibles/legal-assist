...
export default function SeatbeltTicketPage() {
  ...
  const honestFAQs = [
    ...
    { question: "Is it worth fighting a seatbelt ticket?", answer: "Often yes. The 2 points can increase insurance premiums significantly. If you were actually wearing the seatbelt, definitely fight. Even if not, representation sometimes gets tickets reduced or dismissed on technical grounds." },
