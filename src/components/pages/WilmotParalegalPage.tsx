...
export default function WilmotParalegalPage() {
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <div className="max-w-4xl">
            <div className="flex items-center gap-2 text-primary mb-4">
              ...
              <span className="font-paragraph text-sm font-medium">Serving Wilmot & Waterloo Region</span>
            </div>
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
              Wilmot Paralegal Services
            </h1>
            <p className="font-paragraph text-lg md:text-xl text-foreground/70 mb-8 max-w-3xl">
              Affordable legal representation for Wilmot and Waterloo Region residents. We handle traffic tickets, Small Claims Court disputes, and Landlord Tenant Board matters throughout Waterloo Region.
            </p>
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-12 text-center">Our Services in Wilmot</h2>
          <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
            {[
              { icon: Car, title: 'Traffic Ticket Defence', desc: 'Speeding tickets on Highway 7/8, Nafziger Road, and Waterloo Region roads.', link: '/services/traffic-tickets' },
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-xl shadow-sm p-8">
              <p className="font-paragraph text-foreground/80 mb-6">
                We regularly appear at courts serving Wilmot and Waterloo Region:
              </p>
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {['New Hamburg', 'Baden', 'Wilmot', 'Waterloo Region'].map((item, index) => (
                      <li key={index} className="flex items-center gap-2 font-paragraph text-foreground/70 text-sm">
      ...
      <section className="py-16 md:py-20">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8">
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-foreground mb-8 text-center">Why Wilmot Residents Choose Us</h2>
      ...
      <section className="py-16 md:py-20 bg-primary text-primary-foreground">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8 text-center">
          ...
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-6">Need Legal Help in Wilmot?</h2>
      ...
      <section className="py-8 bg-gray-50">
        <div className="max-w-[100rem] mx-auto px-4 md:px-8 text-center">
          <p className="font-paragraph text-sm text-foreground/60">
            ...
            Licensed by the Law Society of Ontario | Serving Wilmot & Waterloo Region
          </p>
        </div>
      </section>
