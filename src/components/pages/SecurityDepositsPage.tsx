...
export default function SecurityDepositsPage() {
  ...
  const honestFAQs = [
    ...
    { question: "Is a damage deposit illegal?", answer: "Yes. Landlords cannot collect deposits for potential damage, no matter what they call it. If you paid a 'damage deposit', 'security deposit', 'cleaning deposit', or 'pet deposit', you may be able to recover it through the LTB." },
    { question: "What about pet deposits?", answer: "Illegal under the Residential Tenancies Act. Landlords cannot charge extra deposits for pets. They also cannot charge pet rent or monthly pet fees. If you paid any of these, you may have a claim for recovery." },
    { question: "Can I get a deposit back that I paid years ago?", answer: "Potentially, though the limitation period may apply. For deposits paid within the last 2 years, recovery is more straightforward. Older deposits may be more complicated but are still potentially recoverable." },
