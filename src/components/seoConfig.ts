...
export const seoConfig: Record<string, SEOConfig> = {
  // ============================================
  // ADMIN PAGES (noindex via [...slug].astro regex)
  // ============================================
  '/admin/disburse-funds': {
    title: 'Disburse Funds | LSO By-Law 9 | Legal Assist Admin',
    description: 'Paralegal admin tool for recording trust and general account disbursements (LSO By-Law 9). Internal use only.',
    keywords: 'disburse funds, trust withdrawal, lso by-law 9, paralegal admin'
  },
  '/admin/month-end-reconciliation': {
    title: 'Month-End Reconciliation | LSO By-Law 9 | Legal Assist Admin',
    description: 'Paralegal admin wizard for monthly trust account reconciliation (LSO By-Law 9). Validates the trust journal, fixes compliance gaps, and locks a permanent snapshot. Internal use only.',
    keywords: 'month-end reconciliation, trust reconciliation, lso by-law 9, form 9c, paralegal admin'
  },
  ...
  '/about': {
    title: 'About Legal Assist | Licensed Paralegal Services',
  ...
  '/about/team': {
    title: 'Meet Our Team | Licensed Paralegals — Legal Assist',
    description: 'Meet the licensed paralegals at Legal Assist: Jean-Francois Demers (LSO #P22020) and Candice Fogarty (LSO #P21479). Serving London and Southwestern Ontario.',
    keywords: 'licensed paralegal london ontario, meet our team, jean-francois demers paralegal, candice fogarty paralegal, LSO P22020, LSO P21479, paralegal credentials',
    schema: { type: 'AboutPage', name: 'Meet Our Team' },
    breadcrumbs: [
      { name: 'Home', url: '/' },
      { name: 'About', url: '/about' },
      { name: 'Meet Our Team', url: '/about/team' }
    ],
    faqs: [
      {
        question: 'Who are the licensed paralegals at Legal Assist?',
        answer: 'Jean-Francois "Johnny" Demers (LSO #P22020) and Candice Fogarty (LSO #P21479). Both are licensed and in good standing with the Law Society of Ontario and carry professional liability insurance.'
      },
      {
        question: 'What areas of law do your paralegals practise in?',
        answer: 'We practise at the Landlord and Tenant Board, Small Claims Court (up to $50,000), Human Rights Tribunal of Ontario, Provincial Offences Court, Licence Appeal Tribunal, and other administrative tribunals where licensed paralegals are permitted to appear.'
      }
    ]
  },
  ...
  '/services': {
    title: 'Legal Services | Traffic Tickets, LTB, Small Claims',
  ...
  '/services/traffic-tickets': {
    title: 'Traffic Ticket Defence | Fight Your Ticket London Ontario',
  ...
  '/services/careless-driving-defence': {
    title: 'Careless Driving Defence | 6 Demerit Points London Ontario',
  ...
  '/services/red-light-tickets': {
    title: 'Red Light Ticket Defence | Run Red Light London Ontario',
  ...
  '/services/demerit-points-guide': {
    title: 'Demerit Points Guide Ontario | How Points Work',
  ...
  '/services/stop-sign-ticket': {
    title: 'Stop Sign Ticket Defence | Rolling Stop London Ontario',
  ...
  '/services/street-racing': {
    title: 'Street Racing Defence | Racing Charge London Ontario',
  ...
  '/services/landlord-tenant-board': {
    title: 'Landlord Tenant Board | LTB Representation London Ontario',
  ...
  '/services/tenant-services': {
    title: 'Tenant Services | Eviction Defence London Ontario',
  ...
  '/services/n12-personal-use-eviction': {
    title: 'N12 Eviction | Landlord Personal Use London Ontario',
  ...
  '/services/n13-renovation-eviction': {
    title: 'N13 Eviction | Renovation Eviction London Ontario',
  ...
  '/services/maintenance-repairs': {
    title: 'Maintenance and Repairs | T6 Application London Ontario',
  ...
  '/services/bad-faith-eviction': {
    title: 'Bad Faith Eviction | T5 Application London Ontario',
  ...
  '/services/rent-increase-guide': {
    title: 'Rent Increase Guide Ontario | Legal Rent Increases',
  ...
  '/services/roommate-disputes': {
    title: 'Roommate Disputes | Shared Living Issues London Ontario',
  ...
  '/services/criminal-matters': {
    title: 'Criminal Matters | Summary Offences London Ontario',
  ...
  '/services/wsib-claims': {
    title: 'WSIB Claims & Appeals | Workplace Injury London Ontario',
  ...
  '/services/odsp-appeals': {
    title: 'ODSP Appeals | Disability Benefits London Ontario',
  ...
  '/services/ontario-works-appeals': {
    title: 'Ontario Works Appeals | OW Benefits London Ontario',
  ...
  '/services/workplace-harassment': {
    title: 'Workplace Harassment | OHSA Complaints London Ontario',
  ...
  '/services/insurance-disputes': {
    title: 'Insurance Disputes | Accident Benefits London Ontario',
  ...
  '/services/bylaw-infractions': {
    title: 'Bylaw Infractions | Provincial Offences London Ontario',
  ...
  '/services/dangerous-dog-hearings': {
    title: 'Dangerous Dog Hearings | Dog Owners Liability London Ontario',
  ...
  '/locations/pembroke': {
    title: 'Pembroke Paralegal | Legal Services Renfrew County',
    description: 'Licensed paralegal services in Pembroke and Renfrew County, Ontario. Traffic ticket defence on Highway 17, small claims court, landlord-tenant disputes.',
  ...
  '/locations/perth': {
    title: 'Perth Paralegal | Legal Services Lanark County',
    description: 'Licensed paralegal services in Perth and Lanark County, Ontario. Traffic tickets, landlord-tenant disputes, small claims court. Serving Smiths Falls, Carleton Place.',
  ...
  '/locations/napanee': {
    title: 'Napanee Paralegal | Legal Services Lennox & Addington',
    description: 'Licensed paralegal services in Napanee and Lennox & Addington County. Traffic ticket defence on Highway 401, small claims court, landlord-tenant disputes.',
  ...
  '/locations/bracebridge': {
    title: 'Bracebridge Paralegal | Legal Services Muskoka',
  ...
  '/locations/parry-sound': {
    title: 'Parry Sound Paralegal | Legal Services Parry Sound District',
  ...
  '/locations/kenora': {
    title: 'Kenora Paralegal | Legal Services Northwestern Ontario',
  ...
  '/locations/cochrane': {
    title: 'Cochrane Paralegal | Legal Services Northeastern Ontario',
  ...
  '/locations/dryden': {
    title: 'Dryden Paralegal | Legal Services Northwestern Ontario',
  ...
  '/locations/fort-frances': {
    title: 'Fort Frances Paralegal | Legal Services Rainy River District',
  ...
  '/locations/temiskaming-shores': {
    title: 'Temiskaming Shores Paralegal | Temiskaming District',
    description: 'Licensed paralegal services in Temiskaming Shores (Haileybury/New Liskeard). Traffic ticket defence on Highway 11, small claims court, landlord-tenant disputes.',
  ...
  '/locations/espanola': {
    title: 'Espanola Paralegal | Legal Services Sudbury District',
  ...
  '/locations/picton': {
    title: 'Picton Paralegal | Legal Services Prince Edward County',
  ...
  '/locations/hawkesbury': {
    title: 'Hawkesbury Paralegal | Legal Services Prescott-Russell',
  ...
  '/locations/petawawa': {
    title: 'Petawawa Paralegal | Legal Services Renfrew County',
    description: 'Licensed paralegal services in Petawawa, Ontario. Traffic ticket defence, small claims court, landlord-tenant disputes. Serving CFB Petawawa military personnel.',
  ...
  '/locations/smiths-falls': {
    title: 'Smiths Falls Paralegal | Legal Services Lanark County',
    description: 'Licensed paralegal services in Smiths Falls, Ontario. Traffic ticket defence, small claims court, landlord-tenant disputes. Serving Rideau Lakes and area.',
  ...
  '/locations/gravenhurst': {
    title: 'Gravenhurst Paralegal | Legal Services Muskoka',
  ...
  '/locations/carleton-place': {
    title: 'Carleton Place Paralegal | Legal Services Lanark County',
  ...
  '/locations/arnprior': {
    title: 'Arnprior Paralegal | Legal Services Renfrew County',
  ...
  '/locations/bancroft': {
    title: 'Bancroft Paralegal | Legal Services Hastings Highlands',
  ...
  '/locations/haldimand-county': {
    title: 'Haldimand County Paralegal | Cayuga Caledonia Dunnville',
    description: 'Licensed paralegal services in Haldimand County. Traffic ticket defence on Highway 6, small claims court, landlord-tenant disputes.',
  ...
  '/locations/alliston': {
    title: 'Alliston Paralegal | Legal Services New Tecumseth',
  ...
  '/locations/wasaga-beach': {
    title: 'Wasaga Beach Paralegal | Legal Services Simcoe County',
  ...
  '/locations/port-colborne': {
    title: 'Port Colborne Paralegal | Legal Services Niagara Region',
  ...
  '/locations/goderich': {
    title: 'Goderich Paralegal | Legal Services Huron County',
  ...
  '/services/debt-negotiation': {
    title: 'Debt Negotiation Services Ontario | Debt Settlement',
  ...
  '/locations': {
    ...
    description: 'Licensed paralegal services across 150+ Ontario cities and towns. Find affordable legal representation near you for traffic tickets, small claims,…',
  ...
  '/locations/brant': {
    ...
    description: 'Licensed paralegal services in Brant and Brant County. Traffic ticket defence on Highway 403 and Highway 24, small claims court, landlord-tenant disputes.',
  ...
  '/locations/clarence-rockland': {
    title: 'Clarence-Rockland Paralegal | Prescott & Russell',
    description: 'Licensed paralegal services in Clarence-Rockland and Prescott & Russell. Traffic ticket defence on Highway 17 and County Road 17, small claims court,…',
  ...
  '/locations/elliot-lake': {
    title: 'Elliot Lake Paralegal | Legal Services Algoma District',
    description: 'Licensed paralegal services in Elliot Lake and Algoma District. Traffic ticket defence on Highway 17 and Highway 108, small claims court, landlord-tenant disputes.',
  ...
  '/locations/prince-edward-county': {
    title: 'Prince Edward County Paralegal | Prince Edward County',
    description: 'Licensed paralegal services in Prince Edward County and Prince Edward County. Traffic ticket defence on Highway 49 and Highway 62, small claims court,…',
  ...
  '/locations/quinte-west': {
    title: 'Quinte West Paralegal | Legal Services Hastings County',
    description: 'Licensed paralegal services in Quinte West and Hastings County. Traffic ticket defence on Highway 401 and Highway 33, small claims court, landlord-tenant disputes.',
  ...
  '/locations/amherstburg': {
    title: 'Amherstburg Paralegal | Legal Services Essex County',
    description: 'Licensed paralegal services in Amherstburg and Essex County. Traffic ticket defence on County Road 20 and Highway 18, small claims court, landlord-tenant disputes.',
  ...
  '/locations/bradford-west-gwillimbury': {
    title: 'Bradford West Gwillimbury Paralegal | Simcoe County',
    description: 'Licensed paralegal services in Bradford West Gwillimbury and Simcoe County. Traffic ticket defence on Highway 400 and Highway 88, small claims court,…',
  ...
  '/locations/east-gwillimbury': {
    title: 'East Gwillimbury Paralegal | Legal Services York Region',
    description: 'Licensed paralegal services in East Gwillimbury and York Region. Traffic ticket defence on Highway 404 and Woodbine Avenue, small claims court, landlord-tenant…',
  ...
  '/locations/erin': {
    title: 'Erin Paralegal | Legal Services Wellington County',
    description: 'Licensed paralegal services in Erin and Wellington County. Traffic ticket defence on Highway 24 and Highway 124, small claims court, landlord-tenant disputes.',
  ...
  '/locations/essex': {
    ...
    description: 'Licensed paralegal services in Essex and Essex County. Traffic ticket defence on Highway 3 and County Road 8, small claims court, landlord-tenant disputes.',
  ...
  '/locations/fergus-elora': {
    title: 'Fergus-Elora Paralegal | Legal Services Wellington County',
    description: 'Licensed paralegal services in Fergus-Elora and Wellington County. Traffic ticket defence on Highway 6 and Highway 7, small claims court, landlord-tenant disputes.',
  ...
  '/locations/fort-erie': {
    title: 'Fort Erie Paralegal | Legal Services Niagara Region',
  ...
  '/locations/gananoque': {
    title: 'Gananoque Paralegal | Legal Services Leeds and Grenville',
    description: 'Licensed paralegal services in Gananoque and Leeds and Grenville. Traffic ticket defence on Highway 401 and Highway 32, small claims court, landlord-tenant disputes.',
  ...
  '/locations/georgina': {
    title: 'Georgina Paralegal | Legal Services York Region',
    description: 'Licensed paralegal services in Georgina and York Region. Traffic ticket defence on Highway 48 and Woodbine Avenue, small claims court, landlord-tenant disputes.',
  ...
  '/locations/innisfil': {
    title: 'Innisfil Paralegal | Legal Services Simcoe County',
    description: 'Licensed paralegal services in Innisfil and Simcoe County. Traffic ticket defence on Highway 400 and Highway 89, small claims court, landlord-tenant disputes.',
  ...
  '/locations/hanover': {
    title: 'Hanover Paralegal | Legal Services Grey County',
    description: 'Licensed paralegal services in Hanover and Grey County. Traffic ticket defence on Highway 4 and Highway 10, small claims court, landlord-tenant disputes.',
  ...
  '/locations/hearst': {
    title: 'Hearst Paralegal | Legal Services Cochrane District',
    description: 'Licensed paralegal services in Hearst and Cochrane District. Traffic ticket defence on Highway 11 and Highway 583, small claims court, landlord-tenant disputes.',
  ...
  '/locations/kapuskasing': {
    title: 'Kapuskasing Paralegal | Legal Services Cochrane District',
    description: 'Licensed paralegal services in Kapuskasing and Cochrane District. Traffic ticket defence on Highway 11 and Highway 581, small claims court, landlord-tenant disputes.',
  ...
  '/locations/kincardine': {
    title: 'Kincardine Paralegal | Legal Services Bruce County',
    description: 'Licensed paralegal services in Kincardine and Bruce County. Traffic ticket defence on Highway 21 and Highway 9, small claims court, landlord-tenant disputes.',
  ...
  '/locations/kingsville': {
    title: 'Kingsville Paralegal | Legal Services Essex County',
    description: 'Licensed paralegal services in Kingsville and Essex County. Traffic ticket defence on County Road 20 and Highway 3, small claims court, landlord-tenant disputes.',
  ...
  '/locations/kirkland-lake': {
    title: 'Kirkland Lake Paralegal | Timiskaming District',
    description: 'Licensed paralegal services in Kirkland Lake and Timiskaming District. Traffic ticket defence on Highway 11 and Highway 66, small claims court, landlord-tenant…',
  ...
  '/locations/lakeshore': {
    title: 'Lakeshore Paralegal | Legal Services Essex County',
    description: 'Licensed paralegal services in Lakeshore and Essex County. Traffic ticket defence on Highway 401 and Highway 77, small claims court, landlord-tenant disputes.',
  ...
  '/locations/lasalle': {
    title: 'LaSalle Paralegal | Legal Services Essex County',
    description: 'Licensed paralegal services in LaSalle and Essex County. Traffic ticket defence on Highway 18 and Huron Church Road, small claims court, landlord-tenant disputes.',
  ...
  '/locations/lincoln': {
    title: 'Lincoln Paralegal | Legal Services Niagara Region',
  ...
  '/locations/marathon': {
    title: 'Marathon Paralegal | Legal Services Thunder Bay District',
    description: 'Licensed paralegal services in Marathon and Thunder Bay District. Traffic ticket defence on Highway 17 (Trans-Canada) and Highway 626, small claims court,…',
  ...
  '/locations/meaford': {
    title: 'Meaford Paralegal | Legal Services Grey County',
    description: 'Licensed paralegal services in Meaford and Grey County. Traffic ticket defence on Highway 26 and County Road 7, small claims court, landlord-tenant disputes.',
  ...
  '/locations/mississippi-mills': {
    title: 'Mississippi Mills Paralegal | Legal Services Lanark County',
    description: 'Licensed paralegal services in Mississippi Mills and Lanark County. Traffic ticket defence on Highway 7 and Highway 29, small claims court, landlord-tenant disputes.',
  ...
  '/locations/mono': {
    title: 'Mono Paralegal | Legal Services Dufferin County',
    description: 'Licensed paralegal services in Mono and Dufferin County. Traffic ticket defence on Highway 10 and Highway 89, small claims court, landlord-tenant disputes.',
  ...
  '/locations/new-tecumseth': {
    title: 'New Tecumseth Paralegal | Legal Services Simcoe County',
    description: 'Licensed paralegal services in New Tecumseth and Simcoe County. Traffic ticket defence on Highway 89 and Highway 400, small claims court, landlord-tenant disputes.',
  ...
  '/locations/niagara-on-the-lake': {
    title: 'Niagara-on-the-Lake Paralegal | Niagara Region',
    description: 'Licensed paralegal services in Niagara-on-the-Lake and Niagara Region. Traffic ticket defence on Niagara Parkway and Highway 55, small claims court,…',
  ...
  '/locations/pelham': {
    title: 'Pelham Paralegal | Legal Services Niagara Region',
    description: 'Licensed paralegal services in Pelham and Niagara Region. Traffic ticket defence on Highway 20 and Canboro Road, small claims court, landlord-tenant disputes.',
  ...
  '/locations/penetanguishene': {
    title: 'Penetanguishene Paralegal | Legal Services Simcoe County',
    description: 'Licensed paralegal services in Penetanguishene and Simcoe County. Traffic ticket defence on Highway 93 and Highway 12, small claims court, landlord-tenant disputes.',
  ...
  '/locations/petrolia': {
    title: 'Petrolia Paralegal | Legal Services Lambton County',
    description: 'Licensed paralegal services in Petrolia and Lambton County. Traffic ticket defence on Highway 21 and County Road 4, small claims court, landlord-tenant disputes.',
  ...
  '/locations/plympton-wyoming': {
    title: 'Plympton-Wyoming Paralegal | Legal Services Lambton County',
    description: 'Licensed paralegal services in Plympton-Wyoming and Lambton County. Traffic ticket defence on Highway 21 and Highway 402, small claims court, landlord-tenant…',
  ...
  '/locations/prescott': {
    title: 'Prescott Paralegal | Legal Services Leeds and Grenville',
    description: 'Licensed paralegal services in Prescott and Leeds and Grenville. Traffic ticket defence on Highway 401 and Highway 2, small claims court, landlord-tenant disputes.',
  ...
  '/locations/renfrew': {
    title: 'Renfrew Paralegal | Legal Services Renfrew County',
    description: 'Licensed paralegal services in Renfrew and Renfrew County. Traffic ticket defence on Highway 17 and Highway 132, small claims court, landlord-tenant disputes.',
  ...
  '/locations/saugeen-shores': {
    title: 'Saugeen Shores Paralegal | Legal Services Bruce County',
    description: 'Licensed paralegal services in Saugeen Shores and Bruce County. Traffic ticket defence on Highway 21 and Highway 9, small claims court, landlord-tenant disputes.',
  ...
  '/locations/shelburne': {
    title: 'Shelburne Paralegal | Legal Services Dufferin County',
    description: 'Licensed paralegal services in Shelburne and Dufferin County. Traffic ticket defence on Highway 10 and Highway 89, small claims court, landlord-tenant disputes.',
  ...
  '/locations/sioux-lookout': {
    title: 'Sioux Lookout Paralegal | Legal Services Kenora District',
    description: 'Licensed paralegal services in Sioux Lookout and Kenora District. Traffic ticket defence on Highway 72 and Highway 664, small claims court, landlord-tenant disputes.',
  ...
  '/locations/south-bruce-peninsula': {
    title: 'South Bruce Peninsula Paralegal | Bruce County',
    description: 'Licensed paralegal services in South Bruce Peninsula and Bruce County. Traffic ticket defence on Highway 6 and Highway 21, small claims court, landlord-tenant…',
  ...
  '/locations/st-marys': {
    title: 'St. Marys Paralegal | Legal Services Perth County',
    description: 'Licensed paralegal services in St. Marys and Perth County. Traffic ticket defence on Highway 7 and Highway 19, small claims court, landlord-tenant disputes.',
  ...
  '/locations/tecumseh': {
    title: 'Tecumseh Paralegal | Legal Services Essex County',
    description: 'Licensed paralegal services in Tecumseh and Essex County. Traffic ticket defence on Manning Road and County Road 22, small claims court, landlord-tenant disputes.',
  ...
  '/locations/blue-mountains': {
    title: 'The Blue Mountains Paralegal | Legal Services Grey County',
    description: 'Licensed paralegal services in The Blue Mountains and Grey County. Traffic ticket defence on Highway 26 and Grey Road 19, small claims court, landlord-tenant…',
  ...
  '/locations/brighton': {
    title: 'Brighton Paralegal | Legal Services Northumberland County',
    description: 'Licensed paralegal services in Brighton and Northumberland County. Traffic ticket defence on Highway 401 and Highway 2, small claims court, landlord-tenant disputes.',
  ...
  '/locations/port-hope': {
    title: 'Port Hope Paralegal | Legal Services Northumberland County',
    description: 'Licensed paralegal services in Port Hope and Northumberland County. Traffic ticket defence on Highway 401 and Highway 2, small claims court, landlord-tenant disputes.',
  ...
  '/locations/kemptville': {
    title: 'Kemptville Paralegal | Legal Services Leeds and Grenville',
    description: 'Licensed paralegal services in Kemptville and Leeds and Grenville. Traffic ticket defence on Highway 416 and Highway 43, small claims court, landlord-tenant disputes.',
  ...
  '/locations/uxbridge': {
    title: 'Uxbridge Paralegal | Legal Services Durham Region',
    description: 'Licensed paralegal services in Uxbridge and Durham Region. Traffic ticket defence on Highway 47 and Highway 12, small claims court, landlord-tenant disputes.',
  ...
  '/locations/scugog': {
    title: 'Scugog Paralegal | Legal Services Durham Region',
    description: 'Licensed paralegal services in Scugog and Durham Region. Traffic ticket defence on Highway 7A and Highway 12, small claims court, landlord-tenant disputes.',
  ...
  '/locations/oro-medonte': {
    title: 'Oro-Medonte Paralegal | Legal Services Simcoe County',
    description: 'Licensed paralegal services in Oro-Medonte and Simcoe County. Traffic ticket defence on Highway 11 and Highway 93, small claims court, landlord-tenant disputes.',
  ...
  '/locations/clearview': {
    title: 'Clearview Paralegal | Legal Services Simcoe County',
    description: 'Licensed paralegal services in Clearview and Simcoe County. Traffic ticket defence on Highway 26 and Highway 91, small claims court, landlord-tenant disputes.',
  ...
  '/locations/severn': {
    title: 'Severn Paralegal | Legal Services Simcoe County',
    description: 'Licensed paralegal services in Severn and Simcoe County. Traffic ticket defence on Highway 11 and Highway 12, small claims court, landlord-tenant disputes.',
  ...
  '/locations/trent-hills': {
    title: 'Trent Hills Paralegal | Legal Services Northumberland County',
    description: 'Licensed paralegal services in Trent Hills and Northumberland County. Traffic ticket defence on Highway 30 and Highway 45, small claims court, landlord-tenant…',
  ...
  '/locations/norwich': {
    title: 'Norwich Paralegal | Legal Services Oxford County',
    description: 'Licensed paralegal services in Norwich and Oxford County. Traffic ticket defence on Highway 59 and Highway 19, small claims court, landlord-tenant disputes.',
  ...
  '/locations/west-lincoln': {
    title: 'West Lincoln Paralegal | Legal Services Niagara Region',
    description: 'Licensed paralegal services in West Lincoln and Niagara Region. Traffic ticket defence on Highway 20 and Regional Road 14, small claims court, landlord-tenant…',
  ...
  '/locations/woolwich': {
    title: 'Woolwich Paralegal | Legal Services Waterloo Region',
    description: 'Licensed paralegal services in Woolwich and Waterloo Region. Traffic ticket defence on Highway 85 and Arthur Street, small claims court, landlord-tenant disputes.',
  ...
  '/locations/wilmot': {
    title: 'Wilmot Paralegal | Legal Services Waterloo Region',
    description: 'Licensed paralegal services in Wilmot and Waterloo Region. Traffic ticket defence on Highway 7/8 and Nafziger Road, small claims court, landlord-tenant disputes.',
  ...
  '/locations/north-dumfries': {
    title: 'North Dumfries Paralegal | Legal Services Waterloo Region',
    description: 'Licensed paralegal services in North Dumfries and Waterloo Region. Traffic ticket defence on Highway 401 and Fountain Street, small claims court, landlord-tenant…',
  ...
  '/locations/centre-wellington': {
    title: 'Centre Wellington Paralegal | Wellington County',
    description: 'Licensed paralegal services in Centre Wellington and Wellington County. Traffic ticket defence on Highway 6 and Highway 7, small claims court, landlord-tenant…',
  ...
  '/locations/mapleton': {
    title: 'Mapleton Paralegal | Legal Services Wellington County',
    description: 'Licensed paralegal services in Mapleton and Wellington County. Traffic ticket defence on Highway 6 and Wellington Road 7, small claims court, landlord-tenant…',
  ...
  '/locations/wellesley': {
    title: 'Wellesley Paralegal | Legal Services Waterloo Region',
    description: 'Licensed paralegal services in Wellesley and Waterloo Region. Traffic ticket defence on Lobsinger Line and Ament Line, small claims court, landlord-tenant disputes.',
  ...
  '/locations/west-grey': {
    title: 'West Grey Paralegal | Legal Services Grey County',
    description: 'Licensed paralegal services in West Grey and Grey County. Traffic ticket defence on Highway 4 and Highway 6, small claims court, landlord-tenant disputes.',
  ...
  '/locations/brockton': {
    title: 'Brockton Paralegal | Legal Services Bruce County',
    description: 'Licensed paralegal services in Brockton and Bruce County. Traffic ticket defence on Highway 4 and Highway 9, small claims court, landlord-tenant disputes.',
  ...
  '/locations/south-huron': {
    title: 'South Huron Paralegal | Legal Services Huron County',
    description: 'Licensed paralegal services in South Huron and Huron County. Traffic ticket defence on Highway 4 and Highway 83, small claims court, landlord-tenant disputes.',
  ...
  '/locations/north-perth': {
    title: 'North Perth Paralegal | Legal Services Perth County',
    description: 'Licensed paralegal services in North Perth and Perth County. Traffic ticket defence on Highway 23 and Highway 86, small claims court, landlord-tenant disputes.',
  ...
  '/locations/zorra': {
    title: 'Zorra Paralegal | Legal Services Oxford County',
    description: 'Licensed paralegal services in Zorra and Oxford County. Traffic ticket defence on Highway 19 and Highway 2, small claims court, landlord-tenant disputes.',
  ...
  '/locations/south-stormont': {
    title: 'South Stormont Paralegal | Legal Services SDG Counties',
    description: 'Licensed paralegal services in South Stormont and SDG Counties. Traffic ticket defence on Highway 401 and Highway 2, small claims court, landlord-tenant disputes.',
  ...
  '/locations/russell': {
    title: 'Russell Paralegal | Legal Services Prescott and Russell',
    description: 'Licensed paralegal services in Russell and Prescott and Russell. Traffic ticket defence on Highway 417 and Highway 138, small claims court, landlord-tenant disputes.',
  ...
  '/locations/south-dundas': {
    title: 'South Dundas Paralegal | Legal Services SDG Counties',
    description: 'Licensed paralegal services in South Dundas and SDG Counties. Traffic ticket defence on Highway 401 and Highway 2, small claims court, landlord-tenant disputes.',
  ...
  '/locations/north-glengarry': {
    title: 'North Glengarry Paralegal | Legal Services SDG Counties',
    description: 'Licensed paralegal services in North Glengarry and SDG Counties. Traffic ticket defence on Highway 34 and Highway 43, small claims court, landlord-tenant disputes.',
  ...
  '/locations/south-glengarry': {
    title: 'South Glengarry Paralegal | Legal Services SDG Counties',
    description: 'Licensed paralegal services in South Glengarry and SDG Counties. Traffic ticket defence on Highway 401 and Highway 34, small claims court, landlord-tenant disputes.',
  ...
  '/locations/loyalist': {
    title: 'Loyalist Paralegal | Legal Services Lennox and Addington',
    description: 'Licensed paralegal services in Loyalist and Lennox and Addington. Traffic ticket defence on Highway 401 and Highway 33, small claims court, landlord-tenant disputes.',
  ...
  '/locations/blind-river': {
    title: 'Blind River Paralegal | Legal Services Algoma District',
    description: 'Licensed paralegal services in Blind River and Algoma District. Traffic ticket defence on Highway 17 (Trans-Canada), small claims court, landlord-tenant disputes.',
  ...
  '/locations/atikokan': {
    title: 'Atikokan Paralegal | Legal Services Rainy River District',
    description: 'Licensed paralegal services in Atikokan and Rainy River District. Traffic ticket defence on Highway 11 and Highway 622, small claims court, landlord-tenant disputes.',
  ...
  '/locations/deep-river': {
    title: 'Deep River Paralegal | Legal Services Renfrew County',
    description: 'Licensed paralegal services in Deep River and Renfrew County. Traffic ticket defence on Highway 17 and Highway 62, small claims court, landlord-tenant disputes.',
  ...
  // ===== Backfilled location entries (added 2026-05-26) =====
  // These pages existed in the sitemap and Router but were missing
  // from seoConfig, so they were inheriting the homepage title /
  // description. Backfilling with per-city SEO closes that gap.

  '/locations/aurora': {
    title: 'Aurora Paralegal | Legal Services York Region',
    description: 'Aurora paralegal services for York Region. Traffic tickets, Small Claims Court, Landlord & Tenant Board. Free consultation. Call 226-272-5153.',
    keywords: 'paralegal aurora, aurora legal services, aurora traffic ticket, york region paralegal, newmarket paralegal',
    schema: { type: 'LocalBusiness', name: 'Legal Assist Aurora', areaServed: ['Aurora', 'Newmarket', 'King', 'York Region'] },
    breadcrumbs: [{ name: 'Home', url: '/' }, { name: 'Locations', url: '/locations' }, { name: 'Aurora', url: '/locations/aurora' }],
    faqs: [
      { question: 'Do you serve Aurora and York Region?', answer: 'Yes, we serve Aurora, Newmarket, King, East Gwillimbury, and all of York Region for paralegal matters.' },
      { question: 'Which courthouse do Aurora residents use?', answer: 'Aurora matters are typically heard at the Newmarket courthouse at 50 Eagle Street West.' },
      { question: 'Do you offer virtual consultations for Aurora?', answer: 'Yes, phone and video consultations are available for all York Region residents.' }
    ]
  },

  '/locations/belleville': {
    title: 'Belleville Paralegal | Quinte Region Legal Services',
    description: 'Belleville paralegal services for Hastings County and the Quinte region. Traffic tickets, Small Claims Court, LTB. Free consultation. Call 226-272-5153.',
    keywords: 'paralegal belleville, belleville legal services, belleville traffic ticket, quinte paralegal, hastings county paralegal',
    schema: { type: 'LocalBusiness', name: 'Legal Assist Belleville', areaServed: ['Belleville', 'Trenton', 'Quinte West', 'Hastings County'] },
    breadcrumbs: [{ name: 'Home', url: '/' }, { name: 'Locations', url: '/locations' }, { name: 'Belleville', url: '/locations/belleville' }],
    faqs: [
