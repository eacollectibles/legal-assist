    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="bg-secondary flex items-center p-8 lg:p-16 xl:p-24 order-2 lg:order-1">
          <div className="max-w-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="tel:+12262725153" className="bg-primary text-white px-8 py-4 rounded-lg font-paragraph text-center flex items-center justify-center gap-2">
                <Phone className="w-5 h-5" /> Call 226-272-5153
              </a>
      ...
      <section className="bg-primary py-4">
        <div className="max-w-[100rem] mx-auto px-6 flex flex-col sm:flex-row items-center justify-center gap-4 text-white text-center">
          ...
          <a href="tel:+12262725153" className="font-heading font-bold text-xl hover:underline">226-272-5153</a>
        </div>
      </section>
      ...
      <section ref={ctaSectionRef} className="py-20 bg-primary/10">
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center">
          ...
          <a href="tel:+12262725153" className="inline-flex items-center gap-2 bg-primary text-white px-8 py-4 rounded-lg font-paragraph text-lg">
            <Phone className="w-5 h-5" /> Call 226-272-5153
          </a>
      ...
      {showStickyBar && (
        <div className="fixed bottom-0 left-0 right-0 bg-secondary border-t border-white/10 py-3 px-4 z-50 sm:hidden" style={{ paddingBottom: 'max(12px, env(safe-area-inset-bottom))' }}>
          <a href="tel:+12262725153" className="flex items-center justify-center gap-2 bg-primary text-white py-3 rounded-lg font-paragraph mb-2">
